...
def search(user_id:str|None=None, saved_before:str|None=None):
    ...
    older_urls_btn = A("Older URLs", href=f"/search?user_id={user_id}&saved_before={oldest_saved_at}", cls="btn btn-primary") if urls and oldest_saved_at else None
...
@rt("/snapshot/stream/{user_id}/{url_id}")
